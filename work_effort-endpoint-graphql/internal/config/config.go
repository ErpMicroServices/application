...
func Load() (*Config, error) {
	...
	viper.AddConfigPath("/etc/work_effort-api")
...
func setDefaults() {
	...
	viper.SetDefault("database.name", "work_effort_db")
	viper.SetDefault("database.user", "work_effort_user")
	viper.SetDefault("database.password", "work_effort_password")
