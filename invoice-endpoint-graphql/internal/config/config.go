...
func Load() (*Config, error) {
	...
	viper.AddConfigPath("/etc/invoice-api")
...
func setDefaults() {
	...
	viper.SetDefault("database.name", "invoice_db")
	viper.SetDefault("database.user", "invoice_user")
	viper.SetDefault("database.password", "invoice_password")
