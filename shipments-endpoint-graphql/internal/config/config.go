...
func Load() (*Config, error) {
	...
	viper.AddConfigPath("/etc/shipments-api")
...
func setDefaults() {
	...
	viper.SetDefault("database.name", "shipments_db")
	viper.SetDefault("database.user", "shipments_user")
	viper.SetDefault("database.password", "shipments_password")
